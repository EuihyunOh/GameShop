...
<article>
<h1>상품등록</h1>  
<!-- 파일을 업로드 하기 위해서는 폼태그를 post 방식으로 전송하고,
...
<tr>
  ...
  <td width="343" colspan="5">
       <input type="text" name="name" size="47" maxlength="100" value="상품명을 적으십시오">
  </td>
</tr>
<tr>
  <th>원가[A]</th>
  ...
  <tr>
    <th>상세설명</th>
    <td colspan="5">
      <textarea name="content" rows="8" cols="70" >이곳에 상품 설명을 적으십시오</textarea>
    </td>
  </tr>
  <tr>
    <th>상품이미지</th>
